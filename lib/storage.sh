...
_jq_normalize_history() {
  cat <<'JQ'
    def normalize_font:
      if . == "Comic Mono" then "ComicMonoNF"
      elif . == "ComicMono Nerd Font" then "ComicMonoNF"
      elif . == "ComicMono NF" then "ComicMonoNF"
      elif . == "comic-mono" then "ComicMonoNF"
      elif . == "robotomono" then "RobotoMono Nerd Font"
